...
cmakeGppArg=" "
extraArg=" "
extraArgWin=" -DINCLUDES=~/Projects/Utils -DVL_DIR=Projects/VL -DDMBCORE_DIR=Projects/DataModelBuilder/Core"
extraArgMac=""
buildConfig="Debug"
logArg=" -DLOG_ON=ON"
build="Build-cmake"
...
[ "$onlyConfig" == true ] && echo "--- Exit without build" && exit || "--- Run cmake --build"
